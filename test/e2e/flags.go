...
type FlagValues struct {
	...
	// HelmExtraValuesPath is the location where the extra values file will be stored.
...
func InitFlags(values *FlagValues) {
	...
	flag.StringVar(&values.HelmExtraValuesPath, "e2e.helm-extra-values-path", "/tmp/.e2e-values.yaml", "path to the extra values file")
